...
tests :: TestTree
tests = testGroup "Blogger.distill"
  [ extractsPostUri
  , extractsPostBody
  , extractsPostTitle
  , canSkipComments
...
canExtractComments =
  ...
  commentDateNoAuthor = commentNoDateNoAuthor
  ...
  commentNoDateAuthor = commentNoDateNoAuthor
  ...
  commentDateAuthor = commentNoDateNoAuthor
    { Atom.entryPublished = Just "2019-01-02T03:04:05Z"
    , Atom.entryAuthors = [ Atom.nullPerson { Atom.personName = "John Doe" } ]
    }
  expectedDateAuthor =
